...
@section('content')
<h1>{{ __('email.welcome.title', ["app_name" => env('APP_NAME')]) }}</h1>
<p>{{ isset($name) ? __('email.greeting_user', ["user" => $name]) : __('email.greeting') }}</p>
<p>{{ __('email.welcome.paragraph_1', ["app_name" => env('APP_NAME')]) }}</p>
<div style="text-align: center; margin: 30px 0;">
    <a class="btn btn-primary"  href="{!! route('home') !!}" target="_blank">{{ __('email.welcome.button_1') }}</a>
</div>
<p style="margin: 0;">{{ __('email.welcome.paragraph_2', ["app_name" => env('APP_NAME')]) }}</p>
<a href="mailto:support@omg.id" target="_blank" class="text-break" >support@omg.id</a>
...
<h2 style="font-size: 20px; font-weight: 400; color: #FFFFFF; margin: 0;">Any question or help?</h2>
<p style="margin: 0;"><a href="{{ env('APP_URL', '#') }}" target="_blank" >Visit this link</a></p>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="center" valign="top" style="background-color: hsl(60, 14%, 91%); padding: 10px 20px 20px 20px; border-radius: 15px 15px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 2px; line-height: 48px;">
                                <h1 style="font-size: 36px; font-weight: 400; margin: 2;">{{ __('email.welcome.title', ["app_name" => env('APP_NAME')]) }}</h1> 
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td bgcolor="#ffffff" align="left" style="background-color: #ECECE6; padding: 2px 30px 10px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <p style="margin: 0;">{{ __('email.welcome.paragraph_1', ["app_name" => env('APP_NAME')]) }}</p>
                            </td>
                        </tr>
                        <tr>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td align="center" style="border-radius: 3px;">
                                                        <a href="{!! route('home') !!}" target="_blank" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 15px 25px; border-radius: 10px; border: 1px solid #19647E; background-color: #19647E; display: inline-block;">{{ __('email.welcome.button_1') }}</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <tr>
                            <td bgcolor="#ffffff" align="left" style="background-color: #ECECE6; padding: 10px 30px 10px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <a href="mailto:support@omg.id" target="_blank" class="text-break" style="color: #ffa333;">support@omg.id</a>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#FFFFFF" align="center" style="background-color: #8B8B8B; padding: 30px 30px 30px 30px; border-radius: 15px 15px 15px 15px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <h2 style="font-size: 20px; font-weight: 400; color: #FFFFFF; margin: 0;">Any question or help?</h2>
                                <p style="margin: 0;"><a href="{{ env('APP_URL', '#') }}" target="_blank" style="color: #FFA333;">Visit this link</a></p>
                            </td>
                        </tr>
                    </table>
                </td>
