...
@section('title',  __('Manage Admin - Edit Role'))
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.administrator.role.update') }}" method="POST" class="mt-2 needs-validation" id="input-form" enctype="multipart/form-data" onsubmit="doSubmit($('#btn-submit'))" autocomplete="off">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="@lang('Role Name')" value="{{ old('name', $model->name) }}" required>
                                        @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <div class="small mt-2">
                                            <strong><i>
                                            *@lang("Warning"): @lang("if you modify this role, the users that assigned by this role won't be able to access menus or can't do actions that related to this roles.") 
                                            </strong></i>
                                        </div>
                                    </div>
                                </div>
