...
@section('title',  __('Manage Admin - Create Admin'))
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                           <h5 class="card-title">@lang('Create New Admin')</h5>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.administrator.list.store') }}" method="POST" class="mt-2 needs-validation" id="input-form" enctype="multipart/form-data" onsubmit="doSubmit($('#btn-submit'))" autocomplete="off">
                            @csrf
                            @method('POST')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="ms-2 me-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="@lang('form.lbl_full_name')" value="{{ old('name') }}" required>
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" id="username" placeholder="@lang('form.lbl_username')" value="{{ old('username') }}" required>
                                            @error('username')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="budi@mail.com" value="{{ old('email') }}" required>
                                            @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input @error('gender') is-invalid @enderror" type="radio" name="gender" id="inlineRadio10" value="male" {{ old('gender') == "male" ? 'checked' : '' }} required>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input @error('gender') is-invalid @enderror" type="radio" name="gender" id="inlineRadio11" value="female" {{ old('gender') == "female" ? 'checked' : '' }} required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input name="status" class="form-check-input @error('status') is-invalid @enderror" type="radio" id="status-active" value="1" {{ old('status') == '1' ? 'checked' : (old('status') == '0' ? '' : 'checked') }} required>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input name="status" class="form-check-input @error('status') is-invalid @enderror" type="radio" id="status-inactive" value="0" {{ old('status') == '0' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="3" style="line-height: 22px;" placeholder="@lang('form.lbl_address')">{{ old('address') }}</textarea>
                                            @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            <div class=" align-items-center text-left">
                                                <div class=" profile-img-edit">
                                                    <img class="img-fluid rounded profile-pic" id="enlarge-img" style="width: 160px; height: 160px;" src="{{ asset('template/images/user/user.png') }}" alt="profile-pic">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="ms-3 me-2">
                                        ...
                                        <div class="form-group" id="role-checkbox">
                                            ...
                                            <div class="form-check me-3">
                                                <input type="checkbox" name="roles[{{$key}}]" class="form-check-input @error("roles.$key") is-invalid @enderror" value="{{ $key }}" id="roles-{{ $key }}" @if(old("roles.$key")) checked @endif>
                                        ...
                                        <div class="form-group" id="permission-checkbox">
                                            ...
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="checkall" class="form-check-input" id="checkAll" @if(old("checkall")) checked @endif>
                                            </div>
                                            <br>
                                            @foreach (collect($permissions)->chunk(2) as $chunkPermissions)
                                                ...
                                                @foreach ($chunkPermissions as $key => $permission)
                                                    <div class="col-md-6">
                                                        <div class="form-check me-3">
                                                            <input type="checkbox" name="permissions[{{$key}}]" class="form-check-input @error("permissions.$key") is-invalid @enderror" value="{{ $key }}" id="permissions-{{ $key }}" @if(old("permissions.$key")) checked @endif >
