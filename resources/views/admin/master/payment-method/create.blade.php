...
@section('title')
    @lang('page.payment_method') - @lang('page.title_create')
@endsection
            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-soft-primary">
                       ...
                       <li class="breadcrumb-item active" aria-current="page">@lang('page.title_create')</li>
                    </ol>
                 </nav>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                           <h5 class="card-title">@lang('page.title_create') @lang('page.payment_method')</h5>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.master.paymentmethod.store') }}" method="POST" class="mt-2 needs-validation" id="input-form" enctype="multipart/form-data" onsubmit="doSubmit($('#btn-submit'))" autocomplete="off">
                            @csrf
                            @method("POST")
                            <div class="row">
                                <div class="col-md-8 ps-3 pe-3">
                                    <div class="form-group">
                                        ...
                                        <input name="name" type="text" id="name" class="form-control mb-0 @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="@lang('Payment Name')" required>
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check custom-radio form-check-inline">
                                            <input type="radio" id="type1" name="type" value="1" onclick="showdiv(1)" class="form-check-input" {{ old('type') ?? 1 == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="customRadio7"> E-Wallet </label>
                                        </div>
                                        <div class="form-check custom-radio form-check-inline">
                                            <input type="radio" id="type2" value="2" name="type" onclick="showdiv(2)" class="form-check-input" {{ old('type') == 2 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group" id="div_payment_type">
                                        ...
                                        <input name="payment_type" type="text" id="payment_type" class="form-control mb-0 @error('payment_type') is-invalid @enderror" value="{{ old('payment_type') }}" placeholder="@lang('Channel Code')" required>
                                        @error('payment_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" id="div_bank_name">
                                        <label class="form-label" for="item_name">@lang('Channel Code') *</label>
                                        <input name="bank_name" type="text" id="bank_name" class="form-control mb-0 @error('bank_name') is-invalid @enderror" value="{{ old('bank_name') }}" placeholder="@lang('Channel Code')" required>
                                        @error('bank_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input name="order" type="number" id="order" class="form-control mb-0 @error('order') is-invalid @enderror" value="{{ old('order') }}" placeholder="@lang('Payment Method Position')" required>
                                        @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
