...
<head>
    ...
    <style>
        ...
        .bg-color-card {
            ...
            box-shadow: -7px 8px 0px 0px var(--color-card-shadow);
        ...
        */
        (function ($) {
            ...
            const init = async () => {
                ...
                const colorCardShadow = qParams.get('goa_t2_color_2');
                if (colorCardShadow) {
                    setStyle('--color-card-shadow', colorCardShadow);
                }
            ...
            const renderWidget = (payloads = {}) => {
                ...
                return `
                    <div class="card color-text text-center bg-color-card animate__animated animate__fadeIn">
                        <div class="card-body p-2">
                            <h4 class="card-title color-text mb-2" id="title"><b>${escape(payloads.title) || `My Goal`}</b></h4>
                            ...
                            <blockquote class="blockquote mb-2">
                                ...
                                <footer class="blockquote-footer color-text font-size-12 mt-1" id="creator_link" ${payloads.showLink != "1" ? 'hidden' : ''}> 
                                    <cite title="Link" class="color-text">${payloads.short_creator_link}&nbsp;</cite>
                                </footer>
                            </blockquote>
                            <div id="show_progress" ${payloads.showProgress != "1" ? 'hidden' : ''}>
