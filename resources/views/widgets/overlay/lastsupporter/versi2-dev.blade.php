...
<body>
    <div class="card border-0  shadow my-5" id="widget-container">
        <div class="card-body  d-flex justify-content-between align-items-center mx-0 ">
            <div class="conten">
                <h5>Lorem, ipsum.</h5>
                ...
                <div class="img-lastsupport p-4">
                    <img src="{{ asset('template/images/icon/icon-user.png') }}" alt="story-img" class="img-usr" width="60" height="60">
                </div>
