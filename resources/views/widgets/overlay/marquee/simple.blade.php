...
<body>
    <div class="acme-news-ticker m-3 rounded-3  animate__animated animate__fadeIn" id="widget-container"></div>  
        ...
        */
        (function ($) {
            ...
            const init = async () => {
                ...
                // Color card body
                const colorCard = qParams.get('mrq_t2_color_1'); 
                if (colorCard) {
                    setStyle('--color-card', colorCard);
                }

                // Color card text label
                const colorCardShadow = qParams.get('mrq_t2_color_2');
                if (colorCardShadow) {
                    setStyle('--color-card-shadow', colorCardShadow);
                }

                // Color card text
                const colorCardText = qParams.get('mrq_t2_color_3');
                if (colorCardText) {
            ...
            const renderLoader = () => {
                // <div class="acme-news-ticker-label rounded-start" hidden>&nbsp;</div>
                return `
                        <div class="acme-news-ticker-box">
