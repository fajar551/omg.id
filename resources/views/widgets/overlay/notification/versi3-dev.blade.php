...
<body class="parent-content">
    <div id="app">
        ...
        <main class="py-2">
            ...
            <div class="card bg-content rounded-0 mx-auto ">
                <div class="card-body  content rounded-0  d-flex aligin-items-center">
                   <div class="">
                   <h6 class="text-indigo text-left pt-2">
                        CROISSANTXX
                        <br>
                        <span>
                    ...
                    <div class="float bg-white col-4 text-right">
                          <img src="{{ asset('template/images/icon/coin.png') }}" alt="" class="text-center" width="40" height="40">
                    </div>
                </div>
            </div>
