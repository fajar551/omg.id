...
<head>
    ...
    <style>
        {!! '.notification__message{ border-left-color  : '.$qParams['ntf_color_1'].'; }' !!}
        ...
        {!! '.bg-float{   background-color : '.$qParams['ntf_color_1'].'; }' !!}
        {!! '.bg-parent{  background-color: '.$qParams['ntf_color_2'].'; }' !!}
        {!! '.bg-parent{ color  : '.$qParams['ntf_color_3'].'; }' !!}
        ...
        <div class="container">
            <!-- <div class="row justify-content-center">
                ...
                <div class="card shadow bg-parent border-0">
                    <div class="card-body px-2 py-3 bg-content">
                        <h6 class="bg-text">
                            CROISSANTXX
                            <br>
                            {{ $qParams['ntf_template_text'] }}
                        </h6>
                        <div class="bg-float  border-0  text-center">
                           <img src="{{ asset('template/images/user/user.png') }}" class="rounded-circle img-fluid mb-2" alt="Sample Image" width="50" height="50" >
                        </div>
                    </div>
                </div>
        </div>
