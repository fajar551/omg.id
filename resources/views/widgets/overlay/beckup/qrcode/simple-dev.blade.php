                ...
                <div class="row justify-content-center">
                    <div class="col-md-4 col-12">
                        <div id="qr-code" class="card card-qr">
                            <div class="card-body">
                                <div class="top-lable mb-2 text-center"><span id="qr-top-text">{{ @$qParams['qrc_top_label'] }}</span></div>
                                ...
                                <div class="top-lable mb-2 text-center"><span id="qr-bottom-text" >{{ @$qParams['qrc_bottom_label'] }}</span></div>
                            </div>
                        </div>
