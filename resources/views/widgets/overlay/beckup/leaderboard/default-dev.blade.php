...
<head>
    ...
    <title>{{ $creatorPage }} Tip Notification Stream</title>
    ...
    <script type="text/javascript">
        ...
        $(() => {
            ...
            Echo.channel("stream.leaderboard.{{ $streamKey }}")
                .listen('.stream.leaderboard', (data) => {
                    const {
                        payloads
                    } = data;
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .leaderboard {
            ...
            width: 351px;
            min-height: 400px;
            background: linear-gradient(to bottom, #2d2d39, #1d1d29);
            border-radius: 10px;
...
<body>
    <div class="leaderboard">
        ...
        <hr style="height: 1px; margin-left:13px; margin-right:13px; background-color:#e1e1e1; border-radius:3px;">
        <ol>
          <li>
