...
<body>
    ...
    <script type="text/javascript">
        ...
        const init = async () => {
            ...
            // Setup color palete
            const colorCardBorder = qParams.get('goa_color_1');
            if (colorCardBorder) {
                setStyle('--color-card-border', colorCardBorder);
            }

            const colorText = qParams.get('goa_color_2');
            if (colorText) {
                setStyle('--color-text', colorText);
            }

            const colorprogress = qParams.get('goa_color_3')
            if (colorprogress) {
        ...
        const renderWidget = (payloads = {}) => {
            ...
            return `
                <div class="card color-text text-center bg-color-card shadow card-border animate__animated animate__fadeIn">
                    <div class="card-body p-2">
                        ...
                        <blockquote class="blockquote mb-3">
                            ...
                            <div class="progress color-progress-border ms-3 me-3" style="height:75%;" id="show_progress" ${payloads.showProgress != "1" ? 'hidden' : ''}>
                                <div class="progress-bar color-progress" role="progressbar" style="width: ${payloads.progress}%;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
                                    <span class="color-text text-weight-60"> ${payloads.progress}% </span> 
                                </div>
                            </div>
                        </blockquote>
                    </div>
