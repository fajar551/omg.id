...
<body class="d-flex flex-column min-vh-100">
    ...
    <script>
        ...
        console.log('Layout loaded, Snap available:', typeof snap !== 'undefined');
        if (typeof snap !== 'undefined') {
            console.log('Snap object in layout:', snap);
            console.log('Snap.pay function available:', typeof snap.pay === 'function');
        } else {
            console.error('Snap is not available in layout!');
        }

        // Wait for Snap to be fully loaded
        window.addEventListener('load', function() {
            console.log('Window loaded, Snap available:', typeof snap !== 'undefined');
            if (typeof snap !== 'undefined') {
                console.log('Snap object after window load:', snap);
            }
        });
    </script>
</body>
