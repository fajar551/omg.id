        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item mx-3 step7 {{ activeRouteName('product.*') }}">
                    <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('product.*') }}" aria-current="page" href="{{ route('product.index') }}">
                        <img src="{{ asset('template/images/icon/ic-product-new.svg') }}" alt="" class="icon-nav my-2 mx-2" width="20" height="20" style="pointer-events: none;">
                        <img src="{{ asset('template/images/icon/ic-product-active-new.svg') }}" alt="" class="icon-active my-2 mx-2" width="20" height="20" style="pointer-events: none;">
                        Produk
                    </a>
                </li>
                @endif
