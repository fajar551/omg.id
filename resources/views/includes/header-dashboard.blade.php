<div class="fixed-top">
    <nav class="container navbar-container navbar navbar-expand-lg navbar-light nav-home d-flex align-items-center justify-content-between px-3 shadow rounded-pill rounded-bottom-3-sm mt-md-3 mt-0"
        id="nav-home" data-aos="fade-down" data-aos-duration="1000">
        <a href="#" class="navbar-toggler burger p-1" type="button" data-bs-toggle="offcanvas"
            ...
            <ul class="navbar-nav mx-auto">
                @if (activeRouteName('supporter.*'))
                    ...
                    <li class="nav-item stepnav1 {{ activeRouteName('supporter.subscribedcontent') }}">
                        <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('supporter.subscribedcontent') }}"
                            aria-current="page" href="{{ route('supporter.subscribedcontent') }}">
                            <img src="{{ asset('template/images/icon/ic-karyaof.svg') }}" alt=""
                                class="icon-nav mx-2 my-2 icon-20">
                            <img src="{{ asset('template/images/icon/ic_karya.svg') }}" alt=""
                                class="icon-active mx-2 my-2 icon-20">
                            @lang('page.content')
                        </a>
                    </li>
                    <li class="nav-item stepnav2 {{ activeRouteName('supporter.supporthistory') }}">
                        <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('supporter.supporthistory') }}"
                    ...
                    <li class="nav-item stepnav3 {{ activeRouteName('supporter.followedcreator') }}">
                        <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('supporter.followedcreator') }}"
                ...
                @else
                    ...
                    <li class="nav-item step1 {{ activeRouteName('home') }}">
                        <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('home') }}"
                    ...
                    <li class="nav-item mx-3 step2 {{ activeRouteName('goal.*') }}">
                        <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('goal.*') }}"
                            aria-current="page" href="{{ route('goal.mygoal.index') }}" data-bs-toggle="tooltip"
                            data-bs-placement="bottom" title="@lang('page.menu_goal')">
                            <img src="{{ asset('template/images/icon/goal-active.png') }}" alt=""
                                class="icon-active my-2 mx-2 icon-20">
                            <img src="{{ asset('template/images/icon/goal.svg') }}" alt=""
                                class="icon-nav my-2 mx-2 icon-20">
                            @lang('page.menu_goal')
                        </a>
                    </li>
                    <li class="nav-item step3 {{ activeRouteName('item.*') }}">
                        <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('item.*') }}"
                    ...
                    <li class="nav-item mx-3 step4 {{ activeRouteName('overlay.*') }}">
                        <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('overlay.*') }}"
                    ...
                    <li
                        class="nav-item step5 {{ activeRouteName('balance.*') }} {{ activeRouteName('payoutaccount.*') }} ">
                        <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('balance.*') }}{{ activeRouteName('payoutaccount.*') }} "
                    ...
                    <li class="nav-item mx-3 step6 {{ activeRouteName('integration.*') }}">
                        <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('integration.*') }}"
                    ...
                    @feature('creator_page')
                        <li class="nav-item step7 {{ activeRouteName('content.*') }}">
                            <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('content.*') }}"
                                aria-current="page" href="{{ route('content.index') }}">
                                <img src="{{ asset('template/images/icon/ic_karya.svg') }}" alt=""
                                    class="icon-active my-2  mx-2" width="20" height="20">
                                <img src="{{ asset('template/images/icon/ic-karyaof.svg') }}" alt=""
                                    class="icon-nav my-2 mx-2" width="20" height="20">
                                @lang('page.content')
                            </a>
                        </li>
                        @if (auth()->check() &&
                                auth()->user()->hasRole(['creator']))
                            <li class="nav-item mx-3 step7 {{ activeRouteName('product.*') }}">
                                <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('product.*') }}"
                                    aria-current="page" href="{{ route('product.index') }}">
                                    <img src="{{ asset('template/images/icon/ic-product-new.svg') }}" alt=""
                                        class="icon-nav my-2 mx-2" width="20" height="20"
                                        style="pointer-events: none;">
                                    <img src="{{ asset('template/images/icon/ic-product-active-new.svg') }}"
                                        alt="" class="icon-active my-2 mx-2" width="20" height="20"
                                        style="pointer-events: none;">
                                    Produk
                                </a>
                            </li>
                        ...
                        @if (auth()->check() &&
                                auth()->user()->hasRole(['creator']))
                            {{-- Hapus menu Produk Saya dan Tambah Produk dari navbar atas --}}
                        @endif
                    @endfeature
                    <li class="nav-item mx-3 step8 {{ activeRouteName('setting.*') }}">
                        <a class="nav-link fw-semibold text-dark d-flex flex-column align-items-center justify-content-center py-1 {{ activeRouteName('setting.*') }}"
        ...
        <div class="d-flex align-items-center justify-content-end ms-auto">
            @auth
                ...
                @include('components.navbar-dropdown-notification', [
                    'dropMode' => 'dropdown-menu-md-end dropdown-menu-end',
                ])
            ...
            @guest
                <li class="nav-item my-auto d-flex gap-2">
                    <a href="{{ route('register') }}" class="btn btn-md btn-outline-info shadow-sm"
