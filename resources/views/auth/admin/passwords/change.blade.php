            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6 bg-white pt-4 pb-lg-5 pb-5">
                    <div class="sign-in-from">
                        <h3 class="mt-3 mb-0">@lang('page.change_password') @lang('(Admin Area)')</h3>
                        @auth
                        <h4 class="mt-1 mb-0">{{ __('email.greeting_user', ["user" => Auth::user()->email]) }}</h4>
                        @endauth 
                        ...
                        <form method="POST" action="{{ route('password.change') }}" class="mt-4 needs-validation" id="auth-form" onsubmit="doSubmit($('#btn-submit'))">
                            ...
                            <div class="d-inline-block w-100">
                                <button type="submit" id="btn-submit" class="btn btn-primary float-end">@lang('form.btn_change_password')</button>
                            </div>
                        </form>
                    </div>
                </div>
