...
@section('content')
                ...
                <div class="col-12">
                    <div class="card shadow rounded-small text-white border-0">
                        <div class="d-flex" style="min-height: 280px; max-height: 280px;">
                            <img src="{{ $data['cover_image'] ?? asset('template/images/herocreator.png') }}"
                                class="cropped cover-image"
                                style="width: 100%; object-fit: cover; border-radius: var(--border-radius-sm);">
                                ...
                                <div class="d-flex align-items-start card-page-info w-100">
                                    <div class="text-center page-thumbnail me-3">
                                        <a href="javascript:void(0);" id="btn-change-icon" data-id="{{ $data['id'] }}">
                                            <img src="{{ $data['avatar'] ?? asset('assets/img/default-item.svg') }}"
                                                alt="profile-img" class="rounded-circle border border-1 shadow-sm">
                                        </a>
                                    </div>
                                    <div class="page-info">
                                        <h4 class="text-line-1 fw-bold" title="">{{ $data['name'] }}</h4>
                                        <p class="mb-0 text-line-1 fw-semibold" title="">
                                            <span>@</span>{{ $data['page_url'] }}
                                        ...
                                        <div clasa="fw-semibold text-white font-creator">
                                            ...
                                            <span class="text-white font-creator" id="countfollowers">
                                                {{ Utils::kNFormatter($data['follow_detail']['followers_count']) }}</span>
                                            <span class="text-white font-creator">&bullet;</span>
                                            <span class="text-white font-creator"> Following
                                                {{ Utils::kNFormatter($data['follow_detail']['followings_count']) }} </span>
                                        </div>
                                        <hr class="mt-2">
                                        <div class="d-flex">
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                class="btn btn-sm btn-light step11 rounded-small"
                                                title="Edit profil halaman">
                            ...
                            <div class="position-absolute top-0 end-0 me-4 mt-4">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#croperr"
                                    class="btn btn-sm btn-light step12 rounded-small" title="Edit cover">
                                    <i class="fa fa-edit"></i> Edit Cover
                                </button>
                                <a href="{{ route('creator.index', ['page_name' => $data['page_url']]) }}" target="_blank"
                                    class="btn btn-sm btn-light text-dark rounded-small" title="Pratinjau halaman">
                            ...
                            <div class="position-absolute bottom-0 end-0">
                                <div class="text-dark d-none d-lg-block me-4 mb-4">
                                    <div class="p-2 badge social-link step13">
                                        <a href="https://facebook.com/{{ $social_link['social_links']['facebook'] }}"><img
                                                src="{{ asset('template/images/fb.png') }}" alt="" width="20"
                                                height="20" class="ms-1 me-1" /></a>
                                        <a href="https://instagram.com/{{ $social_link['social_links']['instagram'] }}"><img
                                                src="{{ asset('template/images/ig.png') }}" alt="" width="20"
                                                height="20" class="ms-1 me-1" /></a>
                                        <a href="https://twitter.com/{{ $social_link['social_links']['twitter'] }}"><img
                                                src="{{ asset('template/images/tw.png') }}" alt="" width="20"
                                                height="20" class="ms-1 me-1" /></a>
                                        <a href="https://youtube.com/{{ $social_link['social_links']['youtube'] }}"><img
                                                src="{{ asset('template/images/yt.png') }}" alt="" width="20"
                                                height="20" class="ms-1 me-1" /></a>
                                    </div>
                                    <a href="{{ route('setting.social.index') }}"
                                        class="btn btn-sm btn-light step14 rounded-small" title="Tambah sosial media link">
                ...
                <div class="col-lg-4 d-lg-block">
                            ...
                            @if (!empty($creatorGoal))
                                <div class="cards bg-primary shadow-0" style="border-radius: 8px;">
                                    <div class="px-3 py-3 bg-subprogress m-auto w-100">
                                        <span class="text-white text-line-2"
                                            style="font-size: 18px; font-weight: 400;">{{ $creatorGoal['goal']['title'] }}</span>
                                        @include('components.goal-progress-sm', [
                                            'progress' => $creatorGoal['goalProgress']['progress'],
                                        ])
                                        <div class="d-flex justify-content-between">
                                            <span
                                                class="text-sm text-white">{{ $creatorGoal['goalProgress']['formated_target_achieved'] }}</span>
                                            <span
                                                class="text-sm text-white">{{ $creatorGoal['goal']['formated_target'] }}</span>
                                        </div>
                                    </div>
                                </div>
                                <a href="{{ route('goal.mygoal.edit', ['id' => $creatorGoal['goal']['id']]) }}"
                                    class="btn btn-sm mt-3 btn-outline-primary text-primary rounded-small"
                                    style="width: -webkit-fill-available;" title="Edit goal">
                                    <i class="fa fa-edit"></i> @lang('form.btn_edit_goal')
                                </a>
                            @else
                                <a href="{{ route('goal.mygoal.create') }}"
                                    class="btn btn-sm mt-3 btn-outline-primary text-primary rounded-small"
                                    style="width: -webkit-fill-available;" title="Buat goal baru">
                    ...
                    <div class="card creators shadow border-0 mb-md-4 mt-md-4 mt-sm-3 card-dark">
                        ...
                        <div class="card-body step16">
                            ...
                            @endif
                            <button type="button" data-bs-toggle="modal" data-bs-target="#summaryModal"
                                class="btn btn-sm mt-3 btn-outline-primary text-primary rounded-small"
                                style="width: -webkit-fill-available;" title="Tambah atau edit summary">
                            ...
                            <div class="modal fade" id="summaryModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('page.setsummary') }}" method="POST"
                                            class="mt-2 needs-validation" id="input-form" enctype="multipart/form-data"
                                            onsubmit="doSubmit($('#btn-submit-summary'))" autocomplete="off">
                                            <div class="modal-body">
                                                {{-- @include('components.flash-message', ['flashName' => 'message',]) --}}
                                                @csrf
                                                <div class="row">
                                                    <div class="form-group">
                                                        <textarea name="summary" class="form-control @error('summary') is-invalid @enderror notif " rows="5"
                                                            style="line-height: 22px;" placeholder="Summary">{{ old('summary', $data['summary']) }}</textarea>
                                                        @error('summary')
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" id="btn-submit-summary"
                    ...
                    <div class="card creators shadow border-0 mb-md-4 mt-md-4 mt-sm-3 card-dark">
                        ...
                        <div class="card-body step17">
                            @if (!empty($data['video']))
                                <iframe height="200" width="100%" src="{{ $data['video'] }}"
                                    title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                    allowfullscreen></iframe>
                            @endif
                            <button type="button" data-bs-toggle="modal" data-bs-target="#videoModal"
                                class="btn btn-sm mt-3 px-4 btn-outline-primary text-primary rounded-small"
                                style="width: -webkit-fill-available;" title="Tambah atau edit video youtube">
                                <i class="fa fa-edit"></i> @lang('page.edit')
                            </button>
                            <div class="modal fade" id="videoModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('page.setvideo') }}" method="POST"
                                            class="mt-2 needs-validation" id="input-form" enctype="multipart/form-data"
                                            onsubmit="doSubmit($('#btn-submit-video'))" autocomplete="off">
                                            <div class="modal-body">
                                                {{-- @include('components.flash-message', [ 'flashName' => 'message', ]) --}}
                                                @csrf
                                                <div class="row">
                                                    <div class="form-group">
                                                        <input type="text" name="video"
                                                            class="form-control @error('video') is-invalid @enderror notif"
                                                            id="video" placeholder="Tambah video dari youtube"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row" id="products-creator">
                            ...
                            @if (auth()->check() && auth()->user()->hasRole('creator'))
                                <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                    <div class="card h-100 shadow-sm border-primary border-2 card-karyas inner-card-dark rounded-xsmall d-flex align-items-center justify-content-center"
                                        style="cursor:pointer; min-height: 250px;" data-bs-toggle="modal"
                                        data-bs-target="#modalTambahProduk" title="Tambah Produk Baru">
                                        <div
                                            ...
                                            <p class="text-primary pt-2 fw-bold" style="font-size:1.2rem;">Tambah Produk
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card creators border-0 mb-md-4 mt-md-4 p-4 card-dark">
                        ...
                        <div class="row step18" id="products-creator">
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12 mb-3 step19">
                                <div class="card card-karyas rounded-xsmall border-primary shadow-sm rounded-small inner-card-dark"
                                    onclick="createKarya()" title="Buat konten baru">
                                    <div
                                        class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                                        <img src="{{ asset('template/images/icon/pluss.svg') }}" alt=""
                                            class="pluss mt-2">
    ...
    <div class="modal  fade" id="croperr" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    ...
                    <div class="page">
                        ...
                        <div class="box d-flex align-items-center">
                            ...
                            <span class="btn btn-upload border-0 btn-file" title="Upload image">
                                <img src="{{ asset('template/images/uploadimg.png') }}" alt="" width="80">
                                <input type="file" id="file-input">
                            </span>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('page.setProfile') }}" method="POST" class="mt-2 needs-validation"
                    id="input-form" enctype="multipart/form-data" onsubmit="doSubmit($('#btn-submit-profile'))"
                    autocomplete="off">
                    <div class="modal-body">
                        {{-- @include('components.flash-message', ['flashName' => 'message']) --}}
                        @csrf
                        <div class="row">
                            <div class="form-group">
                                <label for="name" class="form-label">@lang('form.lbl_name') <span
                                        class="text-danger fw-bold"><span class="text-danger fw-bold">*</span></span>
                                </label>
                                <input type="text" name="name"
                                    class="form-control @error('name') is-invalid @enderror notif" id="name"
                                    placeholder="@lang('form.lbl_name')" value="{{ old('name', $data['name']) }}" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group mt-4">
                                <label for="page_url" class="form-label">@lang('form.lbl_support_page_url') <span
                                        class="text-danger fw-bold"><span class="text-danger fw-bold">*</span></span>
                                </label>
                                <input type="text" name="page_url"
                                    class="form-control @error('page_url') is-invalid @enderror notif" id="page_url"
                                    placeholder="@lang('form.lbl_support_page_url')" value="{{ old('page_url', $data['page_url']) }}"
                                    required>
                                @error('page_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                    ...
                                    @foreach ($category as $item)
                                        @if ($item['id'] != 0)
                                            <option value="{{ $item['id'] }}"
                                                {{ isset($data['category']['id']) ? ($item['id'] == $data['category']['id'] ? 'selected' : '') : '' }}>
                                                {{ $item['title'] }}</option>
                                        @endif
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mt-4">
                                ...
                                <textarea name="page_message" class="form-control @error('page_message') is-invalid @enderror notif " rows="5"
                                    style="line-height: 22px;" placeholder="@lang('form.lbl_support_page_message')" required>{{ old('page_message', $data['page_message']) }}</textarea>
                                @error('page_message')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group mt-4">
                                ...
                                <textarea name="bio" class="form-control @error('bio') is-invalid @enderror notif " rows="5"
                                    style="line-height: 22px;" placeholder="@lang('form.lbl_description')" required>{{ old('bio', $data['bio']) }}</textarea>
                                @error('bio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-8 order-md-1 order-2">
                                <div class="card shadow border-0 rounded-small min-vh-50 card-dark">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="type" class="form-label">Jenis Produk <span
                                                    class="text-danger">*</span></label>
                                ...
                                <div class="card shadow border-0 rounded-small min-vh-50 card-dark">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3 d-flex justify-content-center">
                                            <img class="img-thumbnail rounded icon-160" id="enlarge-img"
                                                src="{{ asset('assets/img/image.png') }}" alt="Preview Gambar">
                                        </div>
                                        <div class="form-group mt-3">
                                            <input type="file" name="image" id="image"
                                                class="form-control @error('image') is-invalid @enderror"
                                                onchange="document.getElementById('enlarge-img').src = window.URL.createObjectURL(this.files[0])"
                                                accept="image/*">
            ...
            $(document).ready(function() {
                ...
                function toggleStockField() {
                    ...
                    if (stockField) {
                        ...
                        stockField.style.display = (selectedType === 'digital' || selectedType === 'ebook' ||
                            selectedType === 'ecourse') ? 'none' : 'block';
