...
@section('title')
    <title>@lang('Create Content')</title>
@endsection
...
@section('content')
    <div class="container px-5 mb-5">
        ...
        <form action="{{ route('content.store') }}" method="POST" class="needs-validation" id="form-content" enctype="multipart/form-data" onsubmit="doSubmit($('#dropdownSubmit'))" autocomplete="off">
            @csrf
            <input type="number" name="status" id="status" value="0" hidden>
                    ...
                    <div class="card border-0 shadow rounded-small min-vh-100 card-dark">
                        <div class="card-body">
                            <div class="px-2 rounded mb-3">
                                ...
                                <textarea name="title" id="content-title" class="form-control mb-4 card-dark @error('title') is-invalid @enderror" placeholder="Judul Konten" rows="2" autocomplete="off" required spellcheck="false" style="overflow: hidden;">{{ old('title') }}</textarea>
                                @error('title')
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column ">
                                <div class="form-group mb-3">
                                    ...
                                    <small class="text-left" id="attachment_info"></small> 
                                    @error('attachment')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="url" name="external_link" id="external_link" class="form-control @error('external_link') is-invalid @enderror" placeholder="https://your-external-link" value="{{ old('external_link') }}" autocomplete="off">
                                    @error('external_link')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="">
                                        <div class="d-flex align-items-center">
                                            <img class="img-fluid thumb-content-preview rounded-top-small border" id="thumbnail-preview" src="{{ asset('template/images/content_thumbnail.png') }}" alt="Cover Image">
                                        </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="social-label input-group-text bg-transparent rounded-0" id="basic-addon1"> 
                                            <img src="{{ $activeItem['icon'] }}" class="img-fluid icon-25" alt="Item Icon" title="{{ $activeItem['name'] }}" style="object-fit:cover;">
                                        </span>
                                        <input type="number" name="qty" id="item-qty" class="form-control @error('qty') is-invalid @enderror" min="0" max="100" value="{{ old('qty', 0) }}" aria-describedby="basic-addon1">
                                    </div>
                                    @endif
                            ...
                            <div class="dropdown ">
                                ...
                                <ul class="dropdown-menu bg-white border-1 shadow rounded-small" aria-labelledby="dropdownSubmit">
                                    ...
                                    <li><a href="{{ route('content.index') }}" class="dropdown-item text-danger"><i class="fas fa-trash"></i> Delete</a></li> --}}
                                </ul>
                            </div>
                        </div>
                    </div>
