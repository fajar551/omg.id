...
class ProfileSettingController extends Controller {
    ...
    public function index(Request $request) {
        try {
            ...
            return view('admin.setting.profile.index', $data);
        } catch (\Exception $ex) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            return WebResponse::success(__("message.update_success"), 'admin.setting.profile.index');
        } catch (\Exception $ex) {
            return WebResponse::error($ex, 'admin.setting.profile.index');
        }
    }
