...
class DiscordIntegrationController extends Controller {
    ...
    protected $services; 
    protected $integrationName = 'discord_webhook'; 
    ...
    public function index(Request $request) {
        try {
            ...
            return view('client.integration.discord.index', $data);
        } catch (\Exception $ex) {
    ...
    public function store(Request $request)
    {
        try {
            ...
            return WebResponse::success(__("message.save_success"), 'integration.discord.index');
        } catch (\Exception $ex) {
            return WebResponse::error($ex, 'integration.discord.index');
        }
    }
